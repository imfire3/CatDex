/**
 * CatDex Design System — dark-first only (MVP).
 * Tokens live here. Screens must not hardcode hex/rgba.
 */
...
/**
 * Light aliases dark — CatDex has no separate light theme in MVP.
 * Prevents a fake dual palette that was identical by accident.
 */
